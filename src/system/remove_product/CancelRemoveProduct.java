...
public class CancelRemoveProduct {
	...
	@Test
	public void cancelRemoveProduct() throws InterruptedException {
		...
		WebElement buttonCancelDelete = webDriver.findElement(By.id("buttonCancelDelete"));
